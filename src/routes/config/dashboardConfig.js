...
export const getDashboardKpiLink = (role, kpiId) => {
  ...
  const links = {
    [ROLES.SUPER_ADMIN]: {
      ...
      bookingsPeriod: `${base}/rentals`,
      jobValue: `${base}/reports/rental-jobs`,
      collected: `${base}/invoices`,
      outstanding: `${base}/invoices`,
      deposits: `${base}/invoices`,
