...
function DeleteProductModal({ product, open, loading, onConfirm, onCancel }) {
  ...
  return (
    <ModalShell onClose={onCancel} aria-labelledby="delete-product-title" overlayClassName="p-stellar-4">
      <Card variant="elevated" className="relative z-10 w-full max-w-md !p-stellar-6">
        <h2 id="delete-product-title" className="text-lg font-semibold text-stellar-text">Delete product</h2>
